...
let CACHE_NAME = `${CACHE_PREFIX}v595`;
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260620k', self.registration.scope).toString(),
  new URL('./script.js?v=20260620s', self.registration.scope).toString(),
