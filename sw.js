...
let CACHE_NAME = `${CACHE_PREFIX}v583`;
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260620c', self.registration.scope).toString(),
  new URL('./script.js?v=20260620j', self.registration.scope).toString(),
