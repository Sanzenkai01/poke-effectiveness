...
const CACHE_NAME = `${CACHE_PREFIX}v499`;
const APP_SHELL = [
  ...
  new URL('./script.js?v=20260615q', self.registration.scope).toString(),
  ...
  new URL('./bosses/bosses.js?v=20260615k', self.registration.scope).toString(),
