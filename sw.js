...
const CACHE_NAME = `${CACHE_PREFIX}v468`;
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260614y', self.registration.scope).toString(),
  new URL('./script.js?v=20260614v', self.registration.scope).toString(),
  ...
  new URL('./bosses/bosses.js?v=20260614a', self.registration.scope).toString(),
  new URL('./times/teams.json?v=20260611c', self.registration.scope).toString(),
