...
const APP_SHELL = [
  ...
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z0.png', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z1.png', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z2.png', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z3.png', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z4.png', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z5.png', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z6.png', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z7.png', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z8.png', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z9.png', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z10.png', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z11.png', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z12.png', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z13.png', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z14.png', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z15.png', self.registration.scope).toString(),
  new URL('./hunt-builder/hunt_symbol.png?v=20260627a', self.registration.scope).toString(),
  new URL('./pokemons/pokemons.json?v=20260723f', self.registration.scope).toString(),
