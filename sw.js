...
let CACHE_NAME = `${CACHE_PREFIX}v991`;
const APP_SHELL = [
  ...
  new URL('./mapa-interativo/index.html', self.registration.scope).toString(),
  ...
  new URL('./styles.css?v=20260801e', self.registration.scope).toString(),
  new URL('./wiki-theme.css?v=20260801e', self.registration.scope).toString(),
  new URL('./script.js?v=20260801g', self.registration.scope).toString(),
  new URL('./mapa-interativo/mapa-interativo.css?v=20260801b', self.registration.scope).toString(),
  new URL('./mapa-interativo/mapa-interativo.js?v=20260801a', self.registration.scope).toString(),
  new URL('./mapa-interativo/data/categories.json?v=20260801a', self.registration.scope).toString(),
  new URL('./mapa-interativo/data/labels.json?v=20260801a', self.registration.scope).toString(),
  new URL('./mapa-interativo/data/markers.json?v=20260801a', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z0.png?v=20260801a', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z1.png?v=20260801a', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z2.png?v=20260801a', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z3.png?v=20260801a', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z4.png?v=20260801a', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z5.png?v=20260801a', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z6.png?v=20260801a', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z7.png?v=20260801a', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z8.png?v=20260801a', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z9.png?v=20260801a', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z10.png?v=20260801a', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z11.png?v=20260801a', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z12.png?v=20260801a', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z13.png?v=20260801a', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z14.png?v=20260801a', self.registration.scope).toString(),
  new URL('./mapa-interativo/assets/minimap-v1.0.0_z15.png?v=20260801a', self.registration.scope).toString(),
  new URL('./hunt-builder/hunt_symbol.png?v=20260627a', self.registration.scope).toString(),
  new URL('./pokemons/pokemons.json?v=20260801b', self.registration.scope).toString(),
  ...
  new URL('./bosses/bosses.js?v=20260801a', self.registration.scope).toString(),
  ...
  new URL('./fusao-de-held/held_coin.png', self.registration.scope).toString(),
