...
let CACHE_NAME = `${CACHE_PREFIX}v517`;
const APP_SHELL = [
  ...
  new URL('./script.js?v=20260618i', self.registration.scope).toString(),
  ...
  new URL('./bosses/bosses.js?v=20260618c', self.registration.scope).toString(),
