...
let CACHE_NAME = `${CACHE_PREFIX}v647`;
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260623u', self.registration.scope).toString(),
  new URL('./script.js?v=20260623y', self.registration.scope).toString(),
  ...
  new URL('./route-loader.js?v=20260623u', self.registration.scope).toString(),
  new URL('./js/main.js', self.registration.scope).toString(),
  new URL('./bosses/bosses.js?v=20260623b', self.registration.scope).toString(),
