...
let CACHE_NAME = `${CACHE_PREFIX}v504`;
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260618c', self.registration.scope).toString(),
  new URL('./script.js?v=20260618c', self.registration.scope).toString(),
