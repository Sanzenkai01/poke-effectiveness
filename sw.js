...
let CACHE_NAME = `${CACHE_PREFIX}v785`;
const APP_SHELL = [
  ...
  new URL('./script.js?v=20260630aq', self.registration.scope).toString(),
  ...
  new URL('./home/home.js?v=20260630m', self.registration.scope).toString(),
