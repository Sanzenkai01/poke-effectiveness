...
let CACHE_NAME = `${CACHE_PREFIX}v539`;
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260618n', self.registration.scope).toString(),
  new URL('./script.js?v=20260619l', self.registration.scope).toString(),
