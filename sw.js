...
let CACHE_NAME = `${CACHE_PREFIX}v781`;
const APP_SHELL = [
  ...
  new URL('./script.js?v=20260630am', self.registration.scope).toString(),
  ...
  new URL('./home/home.js?v=20260630i', self.registration.scope).toString(),
  ...
  new URL('./bosses/bosses.js?v=20260630z', self.registration.scope).toString(),
