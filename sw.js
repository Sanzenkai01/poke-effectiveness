...
let CACHE_NAME = `${CACHE_PREFIX}v604`;
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260621e', self.registration.scope).toString(),
  new URL('./script.js?v=20260621g', self.registration.scope).toString(),
