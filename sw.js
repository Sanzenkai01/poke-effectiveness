...
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260530c', self.registration.scope).toString(),
  new URL('./script.js?v=20260530g', self.registration.scope).toString(),
  ...
  new URL('./js/visits.shared.js?v=20260520i', self.registration.scope).toString(),
  new URL('./route-loader.js?v=20260520c', self.registration.scope).toString(),
  new URL('./js/main.js', self.registration.scope).toString(),
  new URL('./bosses/bosses.js?v=20260528b', self.registration.scope).toString(),
  new URL('./times/teams.json?v=20260530c', self.registration.scope).toString(),
