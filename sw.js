...
let CACHE_NAME = `${CACHE_PREFIX}v614`;
const APP_SHELL = [
  ...
  new URL('./script.js?v=20260622g', self.registration.scope).toString(),
  ...
  new URL('./bosses/bosses.js?v=20260622a', self.registration.scope).toString(),
