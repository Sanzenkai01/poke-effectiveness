...
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260520l', self.registration.scope).toString(),
  new URL('./script.js?v=20260520b', self.registration.scope).toString(),
  ...
  new URL('./bosses/bosses.js?v=20260518a', self.registration.scope).toString(),
