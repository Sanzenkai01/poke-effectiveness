...
let CACHE_NAME = `${CACHE_PREFIX}v833`;
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260705b', self.registration.scope).toString(),
  new URL('./script.js?v=20260705a', self.registration.scope).toString(),
