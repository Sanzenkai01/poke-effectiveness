...
let CACHE_NAME = `${CACHE_PREFIX}v509`;
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260618d', self.registration.scope).toString(),
  new URL('./script.js?v=20260618e', self.registration.scope).toString(),
