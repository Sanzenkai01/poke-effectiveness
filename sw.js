...
let CACHE_NAME = `${CACHE_PREFIX}v870`;
const APP_SHELL = [
  ...
  new URL('./script.js?v=20260718q', self.registration.scope).toString(),
  ...
  new URL('./bosses/bosses.js?v=20260718e', self.registration.scope).toString(),
