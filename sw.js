...
let CACHE_NAME = `${CACHE_PREFIX}v632`;
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260623j', self.registration.scope).toString(),
  new URL('./script.js?v=20260623j', self.registration.scope).toString(),
  ...
  new URL('./route-loader.js?v=20260623j', self.registration.scope).toString(),
  new URL('./js/main.js', self.registration.scope).toString(),
  new URL('./bosses/bosses.js?v=20260622b', self.registration.scope).toString(),
