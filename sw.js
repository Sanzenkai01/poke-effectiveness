...
let CACHE_NAME = `${CACHE_PREFIX}v661`;
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260625b', self.registration.scope).toString(),
  new URL('./script.js?v=20260625k', self.registration.scope).toString(),
