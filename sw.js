...
let CACHE_NAME = `${CACHE_PREFIX}v516`;
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260618i', self.registration.scope).toString(),
  new URL('./script.js?v=20260618h', self.registration.scope).toString(),
