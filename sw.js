...
const APP_SHELL = [
  ...
  new URL('./script.js?v=20260605i', self.registration.scope).toString(),
  ...
  new URL('./bosses/bosses.js?v=20260605d', self.registration.scope).toString(),
  new URL('./times/teams.json?v=20260605c', self.registration.scope).toString(),
