...
let CACHE_NAME = `${CACHE_PREFIX}v779`;
const APP_SHELL = [
  ...
  new URL('./script.js?v=20260630ak', self.registration.scope).toString(),
  ...
  new URL('./home/home.js?v=20260630g', self.registration.scope).toString(),
