...
let CACHE_NAME = `${CACHE_PREFIX}v559`;
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260619j', self.registration.scope).toString(),
  ...
  new URL('./bosses/bosses.js?v=20260618d', self.registration.scope).toString(),
