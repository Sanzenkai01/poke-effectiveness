...
let CACHE_NAME = `${CACHE_PREFIX}v694`;
const APP_SHELL = [
  ...
  new URL('./script.js?v=20260627i', self.registration.scope).toString(),
  new URL('./pokemons/pokemons.json?v=20260627d', self.registration.scope).toString(),
