...
let CACHE_NAME = `${CACHE_PREFIX}v637`;
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260623o', self.registration.scope).toString(),
  new URL('./script.js?v=20260623o', self.registration.scope).toString(),
  ...
  new URL('./route-loader.js?v=20260623o', self.registration.scope).toString(),
