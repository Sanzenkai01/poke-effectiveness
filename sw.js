...
let CACHE_NAME = `${CACHE_PREFIX}v751`;
const APP_SHELL = [
  ...
  new URL('./script.js?v=20260630n', self.registration.scope).toString(),
  ...
  new URL('./home/home.js?v=20260630c', self.registration.scope).toString(),
