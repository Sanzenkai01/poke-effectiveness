...
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260511g', self.registration.scope).toString(),
  new URL('./script.js?v=20260511i', self.registration.scope).toString(),
  ...
  new URL('./bosses/bosses.js?v=20260511i', self.registration.scope).toString(),
