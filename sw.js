...
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260522e', self.registration.scope).toString(),
  new URL('./script.js?v=20260522e', self.registration.scope).toString(),
  ...
  new URL('./bosses/bosses.js?v=20260521f', self.registration.scope).toString(),
  new URL('./times/teams.json?v=20260522a', self.registration.scope).toString(),
