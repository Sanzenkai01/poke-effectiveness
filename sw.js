...
let CACHE_NAME = `${CACHE_PREFIX}v653`;
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260625a', self.registration.scope).toString(),
  new URL('./script.js?v=20260625d', self.registration.scope).toString(),
