...
let CACHE_NAME = `${CACHE_PREFIX}v580`;
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260620b', self.registration.scope).toString(),
  new URL('./script.js?v=20260620h', self.registration.scope).toString(),
  ...
  new URL('./bosses/bosses.js?v=20260619d', self.registration.scope).toString(),
