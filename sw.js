...
let CACHE_NAME = `${CACHE_PREFIX}v598`;
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260621b', self.registration.scope).toString(),
  new URL('./script.js?v=20260621a', self.registration.scope).toString(),
