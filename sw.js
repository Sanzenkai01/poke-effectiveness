...
let CACHE_NAME = `${CACHE_PREFIX}v546`;
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260619d', self.registration.scope).toString(),
  new URL('./script.js?v=20260619q', self.registration.scope).toString(),
