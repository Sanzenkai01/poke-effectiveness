...
let CACHE_NAME = `${CACHE_PREFIX}v563`;
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260619k', self.registration.scope).toString(),
  new URL('./script.js?v=20260619ab', self.registration.scope).toString(),
  ...
  new URL('./route-loader.js?v=20260618a', self.registration.scope).toString(),
  new URL('./js/main.js', self.registration.scope).toString(),
  new URL('./bosses/bosses.js?v=20260619c', self.registration.scope).toString(),
  new URL('./times/teams.json?v=20260619a', self.registration.scope).toString(),
