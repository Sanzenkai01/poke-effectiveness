...
const CACHE_NAME = `${CACHE_PREFIX}v461`;
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260614u', self.registration.scope).toString(),
  new URL('./script.js?v=20260614s', self.registration.scope).toString(),
