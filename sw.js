...
let CACHE_NAME = `${CACHE_PREFIX}v607`;
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260621f', self.registration.scope).toString(),
  new URL('./script.js?v=20260621i', self.registration.scope).toString(),
  ...
  new URL('./bosses/bosses.js?v=20260621d', self.registration.scope).toString(),
