...
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260602c', self.registration.scope).toString(),
  new URL('./script.js?v=20260602e', self.registration.scope).toString(),
  ...
  new URL('./bosses/bosses.js?v=20260602d', self.registration.scope).toString(),
