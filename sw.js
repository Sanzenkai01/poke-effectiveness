...
const CACHE_NAME = `${CACHE_PREFIX}v491`;
const APP_SHELL = [
  ...
  new URL('./script.js?v=20260615j', self.registration.scope).toString(),
  ...
  new URL('./bosses/bosses.js?v=20260615g', self.registration.scope).toString(),
