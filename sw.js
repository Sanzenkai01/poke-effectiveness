...
let CACHE_NAME = `${CACHE_PREFIX}v518`;
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260618j', self.registration.scope).toString(),
  new URL('./script.js?v=20260618j', self.registration.scope).toString(),
