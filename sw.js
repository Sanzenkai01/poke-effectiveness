...
let CACHE_NAME = `${CACHE_PREFIX}v666`;
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260625c', self.registration.scope).toString(),
  new URL('./script.js?v=20260625o', self.registration.scope).toString(),
  new URL('./pokemons/pokedex.json?v=20260625a', self.registration.scope).toString(),
  new URL('./home/home.js?v=20260618a', self.registration.scope).toString(),
  ...
  new URL('./bosses/bosses.js?v=20260625d', self.registration.scope).toString(),
  new URL('./times/teams.json?v=20260620a', self.registration.scope).toString(),
