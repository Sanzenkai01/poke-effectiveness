...
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260612i', self.registration.scope).toString(),
  new URL('./script.js?v=20260612u', self.registration.scope).toString(),
  ...
  new URL('./bosses/bosses.js?v=20260612d', self.registration.scope).toString(),
