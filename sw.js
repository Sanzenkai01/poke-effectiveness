...
const APP_SHELL = [
  ...
  new URL('./styles.css?v=20260602a', self.registration.scope).toString(),
  new URL('./script.js?v=20260602b', self.registration.scope).toString(),
  ...
  new URL('./bosses/bosses.js?v=20260602b', self.registration.scope).toString(),
